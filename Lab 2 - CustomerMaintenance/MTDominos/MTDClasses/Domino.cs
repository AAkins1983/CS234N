...
namespace MTDClasses
{
    ...
    public class Domino //: IComparable<Domino>
    {
        ...
        //public int CompareTo(Domino other) //Comparing object created string's name and other parameter being passed to it.
        //{
        //    //This method returns an int value that determines if the current element is 
        //    //less than, equal to, or greater than the element that's passed as a 
        //    //parameter of the method.
        //    //Score = d.Side1 + d.Side2;
        //    Domino d;
        //    return this.CompareTo(d, Score);
        //}
